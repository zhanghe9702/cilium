...
var (
	...
	// EndpointPropagationDelay is the propagation delay between creation or updation of local CiliumEndpoint
	// received through CiliumEndpoints and CiliumEndpointSlice (if endpoint slice feature is enabled).
