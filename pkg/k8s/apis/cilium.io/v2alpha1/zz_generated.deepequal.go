...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumEnvoyMix) DeepEqual(other *CiliumEnvoyMix) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumEnvoyMixSpec) DeepEqual(other *CiliumEnvoyMixSpec) bool {
	if other == nil {
		return false
	}
	...
	if ((in.Destinations != nil) && (other.Destinations != nil)) || ((in.Destinations == nil) != (other.Destinations == nil)) {
		in, other := &in.Destinations, &other.Destinations
		if other == nil {
			return false
		}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *Destination) DeepEqual(other *Destination) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *Subset) DeepEqual(other *Subset) bool {
	if other == nil {
		return false
	}
