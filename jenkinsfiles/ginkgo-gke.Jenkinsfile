            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:36e357f8a99e914869fb3e39e0a4e3f682bff2b5@sha256:257d332653e77ae88f732cbe05d2b6a3382d46092710be89c97987f931224680"
                    }
                }
            }
        }
